...
public class Challenge2GatesGame extends GatesGame{
	public Challenge2GatesGame() {
		super(2,18,14);
		Wire w2=new Wire(false,1,3);
		Gate gate= new Gate(new Wire(false,1,1),w2,"OR",4,0);
		Gate gateTwo= new Gate(w2,new Wire(false,1,5), "AND",5,0);
		setTile(5, 2, gate);
		setTile(5, 4, gateTwo);
		try {
